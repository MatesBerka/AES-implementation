...
echo "EXPECTED ENCODED TEXT: 69c4e0d86a7b0430d8cdb78070b4c55a (in hex)"
...
echo "EXPECTED ENCODED TEXT: dda97ca4864cdfe06eaf70a0ec0d7191 (in hex)"
echo "encrypting in ECB..."
...
echo "EXPECTED ENCODED TEXT: 8ea2b7ca516745bfeafc49904b496089 (in hex)"
echo "encrypting in ECB..."
